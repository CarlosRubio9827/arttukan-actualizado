            ...
            <section class="section pt-4" >
                ...
                <div class="row">
                    ...
                    <div class="col-6 col-lg-4 mb-4">
                        ...
                        <!--Card-->
                        <div class="card card-ecommerce card-servicio-img-store hoverable h-100 z-depth-1 list-card">
                            ...
                            onclick="mostrar_modal('{{ route("store.servicios.loadImagenes",$servicio->id) }}','img')">
                                ...
                                @else
                                <img src="{{ asset('img/dashboard/servicios/404.png')  }}" class="img-fluid rounded img-thumbnail img-store" alt="404">
                                @endif
                                <a>
