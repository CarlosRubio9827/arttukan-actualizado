@include('include.addons.gmaps.form', array('ubicacion'=>$persona->direccion->ubicacion,'infowindow'=>$persona->primer_nombre." ".$persona->segundo_nombre." ".$persona->primer_apellido." ".$persona->segundo_apellido))
@include('include.dato_basico.direcciones.form', array('direccion'=>$persona->direccion))
