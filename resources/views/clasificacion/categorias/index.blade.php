        ...
        <div class="container-fluid">
            ...
            <div class="card mb-4 wow fadeIn hoverable">
                ...
                <div class="card-body d-sm-flex justify-content-between">
                    ...
                    <span><i class="fas fa-sitemap fa-lg mr-1"></i></span> <span> @if ($categorias->count() === 1)
                Una categoria
        ...
        responsive: {
            details: {
                display: $.fn.dataTable.Responsive.display.modal( {
                    header: function ( row ) {
                        var data = row.data();
                        return '<i class="fas fa-sitemap fa-lg"></i>  Datos de la categoria "'+ data[1]+'"';
                    }
                } ),
